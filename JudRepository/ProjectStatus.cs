...
namespace JudRepository
{
    public class ProjectStatus
    {
        ...
        public ProjectStatus(string strCon, string description)
        {
            strConnection = strCon;
            executor = new Executor(strConnection);
        ...
        public ProjectStatus(string strCon, int id, string description)
        {
            strConnection = strCon;
            executor = new Executor(strConnection);
        ...
        public ProjectStatus(string strCon, ProjectStatus status)
        {
            strConnection = strCon;
            executor = new Executor(strConnection);
        ...
        public List<ProjectStatus> GetProjectStatusList()
        {
            ...
            foreach (string result in results)
            {
                ...
                ProjectStatus status = new ProjectStatus(strConnection, Convert.ToInt32(resultArray[0]), resultArray[1]);
                statuses.Add(status);
            }
            return statuses;
        }
