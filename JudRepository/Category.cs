...
namespace JudRepository
{
    public class Category
    {
        ...
        public Category(string strCon, string name)
        {
            strConnection = strCon;
            executor = new Executor(strConnection);
        ...
        /// <param name="name">string</param>
        public Category(string strCon, int id, string name)
        {
            strConnection = strCon;
            executor = new Executor(strConnection);
        ...
        public Category(string strCon, Category category)
        {
            strConnection = strCon;
            executor = new Executor(strConnection);
        ...
        public List<Category> GetCategories()
        {
            ...
            foreach (string result in results)
            {
                ...
                Category cat = new Category(strConnection, Convert.ToInt32(resultArray[0]), resultArray[1]);
                cats.Add(cat);
            }
            return cats;
        }
