...
namespace JudRepository
{
    public class ZipTown
    {
        ...
        public ZipTown(string strCon, string zip, string town)
        {
            strConnection = strCon;
            executor = new Executor(strConnection);
        ...
        public ZipTown(string strCon, ZipTown zipTown)
        {
            strConnection = strCon;
            executor = new Executor(strConnection);
        ...
        public List<ZipTown> GetZipTownList()
        {
            ...
            foreach (string result in results)
            {
                ...
                ZipTown zipTown = new ZipTown(strConnection, resultArray[0], resultArray[1]);
                zips.Add(zipTown);
            }
            return zips;
        }
