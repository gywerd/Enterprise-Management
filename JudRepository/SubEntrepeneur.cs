...
namespace JudRepository
{
    public class SubEntrepeneur
    {
        ...
        public SubEntrepeneur(string strCon, List<LegalEntity> entrepeneurs, int enterpriseList, string entrepeneur, int contact, int request, int ittLetter, int offer, bool reservations, bool uphold, bool agreementConcluded, bool active)
        {
            strConnection = strCon;
            executor = new Executor(strConnection);
            this.entrepeneurs = entrepeneurs;
