...
namespace JudRepository
{
    public class User
    {
        ...
        public User(string strCon, string initials, string name, string password = "1234", int contactInfo = 0, int jobDescription = 0, bool admin = false)
        {
            strConnection = strCon;
            executor = new Executor(strConnection);
        ...
        /// <param name="passWord">string</param>
        /// <param name="admin">bool</param>
        public User(string strCon, int id, string initials, string name, string passWord, int contactInfo, int jobDescription, bool admin)
        {
            strConnection = strCon;
            executor = new Executor(strConnection);
        ...
        public User(string strCon, User user)
        {
            strConnection = strCon;
            executor = new Executor(strConnection);
        ...
        public List<User> GetUsers()
        {
            ...
            foreach (string result in results)
            {
                ...
                User user = new User(strConnection, Convert.ToInt32(resultArray[0]), resultArray[1], resultArray[2], resultArray[3], Convert.ToInt32(resultArray[4]), Convert.ToInt32(resultArray[5]), Convert.ToBoolean(resultArray[6]));
                users.Add(user);
            }
            return users;
        }
