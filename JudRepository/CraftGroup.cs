...
namespace JudRepository
{
    public class CraftGroup
    {
        ...
        public CraftGroup(string strCon, int category, string designation, string description, bool active)
        {
            strConnection = strCon;
            executor = new Executor(strConnection);
        ...
        /// <param name="designation">string</param>
        /// <param name="description">string</param>
        public CraftGroup(string strCon, int id, int category, string designation, string description, bool active)
        {
            strConnection = strCon;
            executor = new Executor(strConnection);
        ...
        public CraftGroup(string strCon, CraftGroup craftGroup)
        {
            strConnection = strCon;
            executor = new Executor(strConnection);
        ...
        public List<CraftGroup> GetCraftGroups()
        {
            ...
            foreach (string result in results)
            {
                ...
                CraftGroup craftGroup = new CraftGroup(strConnection, Convert.ToInt32(resultArray[0]), Convert.ToInt32(resultArray[1]), resultArray[2], resultArray[3], Convert.ToBoolean(resultArray[4]));
