...
namespace BicBizz
{
    public class Project
    {
        ...
        public bool InsertIntoProject(Project tempProject)
        {
            ...
            result = executor.WriteToDataBase("Projects", strSql);
            return result;
        }
        ...
        private string CreateUpdateSqlQuery(Project project)
        {
            ...
            string result = @"UPDATE dbo.Projects SET CaseId = " + project.Id + ", Name = '" + project.Name + "', Builder = " + project.Builder + ", Status = " + project.Status + ", TenderForm = " + project.TenderForm + ", EnterpriseForm = " + project.EnterpriseForm + ", Executive = " + project.Executive + ", EnterpriseList = '" + project.EnterpriseList + "', Copy = '" + project.Copy + "' WHERE Id = " + project.Id + ";";
            return result;
        }
        ...
        private string CreateDeleteFromSqlQuery(int id)
        {
            ...
            string result = @"DELETE FROM table_name WHERE Id = " + id + ";";
            return result;
        }
